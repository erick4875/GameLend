 ...
 *
 * @param id            ID del juego (opcional para creación, usado en actualización)
 ...
 * @param imagePath     Ruta a imagen preexistente (opcional)
...
public record GameDTO(
    ...
    // Constructor compacto para lógica de inicialización o validación adicional si es necesario
    public GameDTO {
         if (title != null) {
             title = title.trim();
         }
